...
Business Loan showed the highest default rate at approximately 15.46%.
...
Customers were segmented using EMI-to-income ratio:
...
The Very High EMI Burden segment showed the highest default rate.
...
Business Owners showed the highest default rate among the employment segments.
