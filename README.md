...
```mermaid
flowchart TD
    A["8,000 Synthetic Loans"] --> B["Data Quality Validation"]
    B --> C["Feature Engineering"]
    C --> D["Portfolio KPI Analysis"]
    C --> E["Rule-Based Risk Scoring"]
...
```mermaid
flowchart TD
    A["8,000 Loan Records"] --> B["Python Processing"]
    B --> C["Feature Engineering"]
    C --> D["Rule-Based Risk Scoring"]
    C --> E["ML Prediction"]
    E --> E1["Logistic Regression"]
    E --> E2["Random Forest"]
    D --> F["Model Evaluation & Risk Analytics"]
    E1 --> F
    E2 --> F
    F --> G["SQLite Database"]
    G --> H["FastAPI"]
    H --> I["Streamlit Dashboard"]
    F --> J["Power BI Reporting"]
```
